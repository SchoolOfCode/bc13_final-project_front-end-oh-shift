...
/**
 * 
 * @param {*} title - Property from the database. The '../../GameCardLIst/gameCardList.js' passes down to '../../Gamecard/gamecard.js', passes down to this element the image elements of our games database
 * @param {*} id - Property from the database. The '../../GameCardLIst/gameCardList.js' passes down to '../../Gamecard/gamecard.js', passes down to this element the image elements of our games database
 * @returns the base of the Review page in the cards. 
 */
...
function Review({ title, id }) {
  ...
  async function handleDelete(id) {
    if (id) {
      ...
      alert("Something went wrong when trying to delete review");
    }
  }
